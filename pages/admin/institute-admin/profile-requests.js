...
function InstituteAdminProfileRequests({ showToast }) {
  ...
  return (
    <AdminProtectedRoute adminType="institute">
      <Head>
        <title>Profile Update Requests - Institute Admin</title>
      </Head>
...
InstituteAdminProfileRequests.getLayout = function getLayout(page) {
  return <AdminSidebarLayout title="Profile Update Requests">{page}</AdminSidebarLayout>;
};

export default InstituteAdminProfileRequests;
