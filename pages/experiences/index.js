        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8 sticky top-0 z-10 bg-gray-50 py-4">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              ...
              <Link href="/experiences/new" className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl text-white bg-primary-600 hover:bg-primary-700 shadow-lg font-medium transition-all transform hover:scale-105">
